...
def aotomate_chrome_open_bitmovin():
    ...
    regionDialog = wait_for_screen(screenshot_path(r"drm\dialog.png"), return_region=True, region=chrome_region)
    wait_and_click(screenshot_path(r"drm\allow.png"), region=regionDialog)
    wait_and_click(screenshot_path(r"drm\accept.png"), region=chrome_region)
    time.sleep(1.5)
